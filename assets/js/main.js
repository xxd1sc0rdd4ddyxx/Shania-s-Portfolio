				...
				$('#contactForm').submit(function(event) {
					...
					$.ajax({
						...
						success: function(response, textStatus, jqXHR) {
							// Wenn die Anfrage erfolgreich ist, wird die Bestätigungsnachricht angezeigt
							confirmationMessage.fadeIn(); // Zeigt die Bestätigungsnachricht an
							form[0].reset(); // Formular zurücksetzen
